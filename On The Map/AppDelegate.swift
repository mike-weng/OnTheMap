...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func showOverwriteAlert(viewController: UIViewController, title: String, message: String, handler: (UIAlertAction) -> Void) {
        let alert = UIAlertController(title: title, message: message, preferredStyle: UIAlertControllerStyle.Alert)
        
        // add an action (button)
        alert.addAction(UIAlertAction(title: "Overwrite", style: UIAlertActionStyle.Default, handler: handler))
